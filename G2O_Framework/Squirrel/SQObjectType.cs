// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SQObjectType.cs" company="Colony Online Project">
...
namespace GothicOnline.G2.DotNet.Squirrel.Squirrel
{
    public enum SqObjectType
    {
        ...
        OtInteger =
            SquirrelObjectTypeMask.RtInteger | SquirrelObjectTypeMask.SqobjectNumeric
            | SquirrelObjectTypeMask.SqobjectCanbefalse, 

        OtFloat =
            SquirrelObjectTypeMask.RtFloat | SquirrelObjectTypeMask.SqobjectNumeric
            | SquirrelObjectTypeMask.SqobjectCanbefalse, 
        ...
        OtTable =
            SquirrelObjectTypeMask.RtTable | SquirrelObjectTypeMask.SqobjectRefCounted
            | SquirrelObjectTypeMask.SqobjectDelegable, 

        OtArray = SquirrelObjectTypeMask.RtArray | SquirrelObjectTypeMask.SqobjectRefCounted, 

        OtUserdata =
            SquirrelObjectTypeMask.RtUserdata | SquirrelObjectTypeMask.SqobjectRefCounted
            | SquirrelObjectTypeMask.SqobjectDelegable, 
        ...
        OtFuncproto = SquirrelObjectTypeMask.RtFuncproto | SquirrelObjectTypeMask.SqobjectRefCounted, 

        // internal usage only
        OtClass = SquirrelObjectTypeMask.RtClass | SquirrelObjectTypeMask.SqobjectRefCounted, 

        OtInstance =
            SquirrelObjectTypeMask.RtInstance | SquirrelObjectTypeMask.SqobjectRefCounted
            | SquirrelObjectTypeMask.SqobjectDelegable, 
